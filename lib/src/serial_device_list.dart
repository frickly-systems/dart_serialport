...
@immutable
sealed class SerialDeviceList {
  factory SerialDeviceList() {
    if (Platform.isLinux) {
      return const SerialDeviceListLinux();
    } else {
...
@immutable
class SerialDeviceListLinux implements SerialDeviceList {
  const SerialDeviceListLinux();
